...
- Diagnose positive-rate alarms before changing gates. Recent alarm folds are threshold cliffs where capped thresholds collapse recall and unconstrained thresholds flood; these require model/calibration fixes, not promotion-threshold relaxation.
