...
def _pixel_metrics_from_probs(probs: np.ndarray, labels: np.ndarray, train_labels: np.ndarray, threshold: float, artifact_dir: Path, extra: Dict[str, Any], eval_cfg: Dict[str, Any] | None = None) -> Dict[str, Any]:
    ...
    fixed_threshold_failure_reason = _fixed_threshold_failure_reason(fixed, best_f1_row)
    metrics = {
        "val_loss": val_loss,
        ...
        "threshold_risk_summary": _threshold_risk_summary(threshold_rows, fixed, best_f1_row, val_positive_rate, max_ratio, min_ratio),
